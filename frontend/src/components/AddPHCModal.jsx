...
export const AddPHCModal = ({ onClose, onAdd }) => {
  ...
  const [stockItems, setStockItems] = useState([
    { itemName: 'Paracetamol 500mg', currentUnits: 0, avgDailyConsumption: 100 },
    { itemName: 'Amoxicillin 250mg', currentUnits: 0, avgDailyConsumption: 50 },
    { itemName: 'ORS Packets', currentUnits: 0, avgDailyConsumption: 50 },
    { itemName: 'IV Fluids', currentUnits: 0, avgDailyConsumption: 40 },
    { itemName: 'Syringes', currentUnits: 0, avgDailyConsumption: 150 },
    { itemName: 'Bandages', currentUnits: 0, avgDailyConsumption: 50 }
  ]);
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
      <div className="bg-white border-2 border-[#111] w-full max-w-2xl flex flex-col max-h-[90vh] shadow-[0_20px_50px_rgba(0,0,0,0.2)]">
        ...
        <div className="flex items-center justify-between px-8 py-6 border-b-2 border-[#111]">
          <h2 className="text-lg font-bold tracking-[0.15em] uppercase text-[#111]">Register New PHC</h2>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="p-6 border-t-2 border-[#111] bg-gray-50 flex justify-end gap-4">
            ...
            <button
              type="submit"
              className="px-8 py-3 bg-[#111] text-white text-xs font-bold uppercase tracking-[0.15em] hover:bg-black transition-colors"
            >
              Save PHC
            </button>
          </div>
